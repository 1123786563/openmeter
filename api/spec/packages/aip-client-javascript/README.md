...
| Method                   | HTTP                        | Description                                                                                                 |
| ------------------------ | --------------------------- | ----------------------------------------------------------------------------------------------------------- |
| `client.namespaces.list` | `GET /openmeter/namespaces` | List the namespaces available on this deployment. The default namespace is always included in the response. |
...
| `client.commerce.listRechargeProducts`  | `GET /recharge-products`                                                     | List recharge products available for purchase. By default only active products are returned; pass `include_inactive` to also list delisted products (for the admin catalog management view).                                                                                                                                                                                                                  |
| `client.commerce.createRechargeProduct` | `POST /recharge-products`                                                    | Create a new recharge product in the catalog. Admin-only mutation.                                                                                                                                                                                                                                                                                                                                            |
| `client.commerce.updateRechargeProduct` | `PATCH /recharge-products/{productId}`                                       | Update a recharge product's mutable fields (name, price, active listing state). Admin-only mutation; `sku`, `kind`, and `credits` are immutable.                                                                                                                                                                                                                                                              |
...
| `client.commerce.listOrders`            | `GET /orders`                                                                | List orders in the namespace, newest first. Supports pagination and optional customer and status filters.                                                                                                                                                                                                                                                                                                     |
