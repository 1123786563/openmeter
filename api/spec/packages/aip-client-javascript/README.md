...
| `client.commerce.wechatRefundCallback`  | `POST /payment-providers/wechat/refund-callback`                             | WeChat Pay refund callback. OpenMeter verifies and decrypts the notification, then applies the authoritative refund fact.                                                                  |
