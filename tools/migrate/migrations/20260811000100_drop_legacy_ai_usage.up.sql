-- Retire the legacy AIUsage schema after Credit Reservation v2 cutover.
-- Native ledger, credit grant, customer, purchase, and payment tables are not touched.

-- Drop tables and indexes in dependency order (children before parents).
