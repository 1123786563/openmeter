...
-- Restore the final legacy ratecard shape that existed immediately before the drop.
ALTER TABLE "ai_usage_ratecard_entries"
  ADD COLUMN "credits_per_unit" bigint NOT NULL DEFAULT 1,
  ADD COLUMN "unit_size" bigint NOT NULL DEFAULT 1,
