...
func (_m *AIUsageAllocationQuery) Paginate(ctx context.Context, page pagination.Page) (pagination.Result[*AIUsageAllocation], error) {
	...
	pagedResponse := pagination.Result[*AIUsageAllocation]{
		Page: page,
	}
	...
	if count == 0 {
		...
		pagedResponse.Items = make([]*AIUsageAllocation, 0)
...
// type check
var _ pagination.Paginator[*AIUsageAllocation] = (*AIUsageAllocationQuery)(nil)

// Paginate runs the query and returns a paginated response.
// If page is its 0 value then it will return all the items and populate the response page accordingly.
func (_m *AIUsageBatchQuery) Paginate(ctx context.Context, page pagination.Page) (pagination.Result[*AIUsageBatch], error) {
	// Get the limit and offset
	limit, offset := page.Limit(), page.Offset()
	...
	pagedResponse := pagination.Result[*AIUsageBatch]{
		Page: page,
	}
	...
	if count == 0 {
		// Items should be [] not null.
		pagedResponse.Items = make([]*AIUsageBatch, 0)
		return pagedResponse, nil
	}
...
// type check
var _ pagination.Paginator[*AIUsageBatch] = (*AIUsageBatchQuery)(nil)

// Paginate runs the query and returns a paginated response.
// If page is its 0 value then it will return all the items and populate the response page accordingly.
func (_m *AIUsageLineItemQuery) Paginate(ctx context.Context, page pagination.Page) (pagination.Result[*AIUsageLineItem], error) {
	// Get the limit and offset
	limit, offset := page.Limit(), page.Offset()
	...
	pagedResponse := pagination.Result[*AIUsageLineItem]{
		Page: page,
	}
	...
	if count == 0 {
		// Items should be [] not null.
		pagedResponse.Items = make([]*AIUsageLineItem, 0)
		return pagedResponse, nil
	}
...
// type check
var _ pagination.Paginator[*AIUsageLineItem] = (*AIUsageLineItemQuery)(nil)

// Paginate runs the query and returns a paginated response.
// If page is its 0 value then it will return all the items and populate the response page accordingly.
func (_m *AIUsageOutboxQuery) Paginate(ctx context.Context, page pagination.Page) (pagination.Result[*AIUsageOutbox], error) {
	// Get the limit and offset
	limit, offset := page.Limit(), page.Offset()
	...
	pagedResponse := pagination.Result[*AIUsageOutbox]{
		Page: page,
	}
	...
	if count == 0 {
		// Items should be [] not null.
		pagedResponse.Items = make([]*AIUsageOutbox, 0)
		return pagedResponse, nil
	}
...
// type check
var _ pagination.Paginator[*AIUsageOutbox] = (*AIUsageOutboxQuery)(nil)

// Paginate runs the query and returns a paginated response.
// If page is its 0 value then it will return all the items and populate the response page accordingly.
func (_m *AIUsageRatecardEntryQuery) Paginate(ctx context.Context, page pagination.Page) (pagination.Result[*AIUsageRatecardEntry], error) {
	// Get the limit and offset
	limit, offset := page.Limit(), page.Offset()
	...
	pagedResponse := pagination.Result[*AIUsageRatecardEntry]{
		Page: page,
	}
	...
	if count == 0 {
		// Items should be [] not null.
		pagedResponse.Items = make([]*AIUsageRatecardEntry, 0)
		return pagedResponse, nil
	}
...
// type check
var _ pagination.Paginator[*AIUsageRatecardEntry] = (*AIUsageRatecardEntryQuery)(nil)

// Paginate runs the query and returns a paginated response.
// If page is its 0 value then it will return all the items and populate the response page accordingly.
func (_m *AIUsageRatingSnapshotQuery) Paginate(ctx context.Context, page pagination.Page) (pagination.Result[*AIUsageRatingSnapshot], error) {
	// Get the limit and offset
	limit, offset := page.Limit(), page.Offset()
	...
	pagedResponse := pagination.Result[*AIUsageRatingSnapshot]{
		Page: page,
	}
	...
	if count == 0 {
		// Items should be [] not null.
		pagedResponse.Items = make([]*AIUsageRatingSnapshot, 0)
		return pagedResponse, nil
	}
...
// type check
var _ pagination.Paginator[*AIUsageRatingSnapshot] = (*AIUsageRatingSnapshotQuery)(nil)

// Paginate runs the query and returns a paginated response.
// If page is its 0 value then it will return all the items and populate the response page accordingly.
func (_m *AIUsageWatermarkQuery) Paginate(ctx context.Context, page pagination.Page) (pagination.Result[*AIUsageWatermark], error) {
	// Get the limit and offset
	limit, offset := page.Limit(), page.Offset()
	...
	pagedResponse := pagination.Result[*AIUsageWatermark]{
		Page: page,
	}
	...
	if count == 0 {
		// Items should be [] not null.
		pagedResponse.Items = make([]*AIUsageWatermark, 0)
		return pagedResponse, nil
	}
...
// type check
var _ pagination.Paginator[*AIUsageWatermark] = (*AIUsageWatermarkQuery)(nil)
...
// Paginate runs the query and returns a paginated response.
// If page is its 0 value then it will return all the items and populate the response page accordingly.
func (_m *CommerceOutboxQuery) Paginate(ctx context.Context, page pagination.Page) (pagination.Result[*CommerceOutbox], error) {
	// Get the limit and offset
	limit, offset := page.Limit(), page.Offset()
	...
	pagedResponse := pagination.Result[*CommerceOutbox]{
		Page: page,
	}
	...
	if count == 0 {
		// Items should be [] not null.
		pagedResponse.Items = make([]*CommerceOutbox, 0)
		return pagedResponse, nil
	}
...
// type check
var _ pagination.Paginator[*CommerceOutbox] = (*CommerceOutboxQuery)(nil)
...
// Paginate runs the query and returns a paginated response.
// If page is its 0 value then it will return all the items and populate the response page accordingly.
func (_m *CreditChargeQuery) Paginate(ctx context.Context, page pagination.Page) (pagination.Result[*CreditCharge], error) {
	// Get the limit and offset
	limit, offset := page.Limit(), page.Offset()
	...
	pagedResponse := pagination.Result[*CreditCharge]{
		Page: page,
	}
	...
	if count == 0 {
		// Items should be [] not null.
		pagedResponse.Items = make([]*CreditCharge, 0)
		return pagedResponse, nil
	}
...
// type check
var _ pagination.Paginator[*CreditCharge] = (*CreditChargeQuery)(nil)
...
// Paginate runs the query and returns a paginated response.
// If page is its 0 value then it will return all the items and populate the response page accordingly.
func (_m *CreditReservationQuery) Paginate(ctx context.Context, page pagination.Page) (pagination.Result[*CreditReservation], error) {
	// Get the limit and offset
	limit, offset := page.Limit(), page.Offset()
	...
	pagedResponse := pagination.Result[*CreditReservation]{
		Page: page,
	}
	...
	if count == 0 {
		// Items should be [] not null.
		pagedResponse.Items = make([]*CreditReservation, 0)
		return pagedResponse, nil
	}
...
// type check
var _ pagination.Paginator[*CreditReservation] = (*CreditReservationQuery)(nil)

// Paginate runs the query and returns a paginated response.
// If page is its 0 value then it will return all the items and populate the response page accordingly.
func (_m *CreditReservationCommandQuery) Paginate(ctx context.Context, page pagination.Page) (pagination.Result[*CreditReservationCommand], error) {
	// Get the limit and offset
	limit, offset := page.Limit(), page.Offset()
	...
	pagedResponse := pagination.Result[*CreditReservationCommand]{
		Page: page,
	}
	...
	if count == 0 {
		// Items should be [] not null.
		pagedResponse.Items = make([]*CreditReservationCommand, 0)
		return pagedResponse, nil
	}
...
// type check
var _ pagination.Paginator[*CreditReservationCommand] = (*CreditReservationCommandQuery)(nil)

// Paginate runs the query and returns a paginated response.
// If page is its 0 value then it will return all the items and populate the response page accordingly.
func (_m *CreditReservationOutboxQuery) Paginate(ctx context.Context, page pagination.Page) (pagination.Result[*CreditReservationOutbox], error) {
	// Get the limit and offset
	limit, offset := page.Limit(), page.Offset()
	...
	pagedResponse := pagination.Result[*CreditReservationOutbox]{
		Page: page,
	}
	...
	if count == 0 {
		// Items should be [] not null.
		pagedResponse.Items = make([]*CreditReservationOutbox, 0)
		return pagedResponse, nil
	}
...
// type check
var _ pagination.Paginator[*CreditReservationOutbox] = (*CreditReservationOutboxQuery)(nil)
...
// Paginate runs the query and returns a paginated response.
// If page is its 0 value then it will return all the items and populate the response page accordingly.
func (_m *CustomerAIRatePackageQuery) Paginate(ctx context.Context, page pagination.Page) (pagination.Result[*CustomerAIRatePackage], error) {
	// Get the limit and offset
	limit, offset := page.Limit(), page.Offset()
	...
	pagedResponse := pagination.Result[*CustomerAIRatePackage]{
		Page: page,
	}
	...
	if count == 0 {
		// Items should be [] not null.
		pagedResponse.Items = make([]*CustomerAIRatePackage, 0)
		return pagedResponse, nil
	}
...
// type check
var _ pagination.Paginator[*CustomerAIRatePackage] = (*CustomerAIRatePackageQuery)(nil)

// Paginate runs the query and returns a paginated response.
// If page is its 0 value then it will return all the items and populate the response page accordingly.
func (_m *CustomerCreditLimitQuery) Paginate(ctx context.Context, page pagination.Page) (pagination.Result[*CustomerCreditLimit], error) {
	// Get the limit and offset
	limit, offset := page.Limit(), page.Offset()
	...
	pagedResponse := pagination.Result[*CustomerCreditLimit]{
		Page: page,
	}
	...
	if count == 0 {
		// Items should be [] not null.
		pagedResponse.Items = make([]*CustomerCreditLimit, 0)
		return pagedResponse, nil
	}
...
// type check
var _ pagination.Paginator[*CustomerCreditLimit] = (*CustomerCreditLimitQuery)(nil)
...
// Paginate runs the query and returns a paginated response.
// If page is its 0 value then it will return all the items and populate the response page accordingly.
func (_m *ManualResourceCostQuery) Paginate(ctx context.Context, page pagination.Page) (pagination.Result[*ManualResourceCost], error) {
	// Get the limit and offset
	limit, offset := page.Limit(), page.Offset()
	...
	pagedResponse := pagination.Result[*ManualResourceCost]{
		Page: page,
	}
	...
	if count == 0 {
		// Items should be [] not null.
		pagedResponse.Items = make([]*ManualResourceCost, 0)
		return pagedResponse, nil
	}
...
// type check
var _ pagination.Paginator[*ManualResourceCost] = (*ManualResourceCostQuery)(nil)
