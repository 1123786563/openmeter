...
func (_m *AIUsageBatchQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*AIUsageBatch], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*AIUsageBatch]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	if err != nil {
		return pagination.Result[*AIUsageBatch]{}, err
	}

	if items == nil {
		items = make([]*AIUsageBatch, 0)
	}

	result := pagination.Result[*AIUsageBatch]{
		Items: items,
	}
...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *AIUsageLineItemQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*AIUsageLineItem], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*AIUsageLineItem]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*AIUsageLineItem]{}, err
	}

	if items == nil {
		items = make([]*AIUsageLineItem, 0)
	}

	result := pagination.Result[*AIUsageLineItem]{
		Items: items,
	}
...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *AIUsageRatingSnapshotQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*AIUsageRatingSnapshot], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*AIUsageRatingSnapshot]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*AIUsageRatingSnapshot]{}, err
	}

	if items == nil {
		items = make([]*AIUsageRatingSnapshot, 0)
	}
